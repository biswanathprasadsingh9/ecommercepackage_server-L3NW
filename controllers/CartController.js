...
const getcartitems = (req,res) => {
    ...
    .then(resdata=>{
      ...
      if(resdata.length===0){
        ...
        // Cart.updateMany({system_id:req.params.system_id,user_id:null},{$set:{ user_id:req.params.user_id}})
        // .then(ada=>{
        //
        //   // if(resdata.length===i+1){
        //     Cart.find({user_id:req.params.user_id})
...
module.exports = {
  store,addcheckcart,gencartitemlocal,getcartitems,getcartitemsnologin,remove
};
